...
for file in lib/base.sh lib/logging.sh lib/users.sh lib/desktop.sh lib/vmware.sh lib/disk.sh lib/bootloader.sh; do
...
for module in /root/base.sh /root/logging.sh /root/users.sh /root/desktop.sh /root/vmware.sh /root/disk.sh /root/bootloader.sh; do
